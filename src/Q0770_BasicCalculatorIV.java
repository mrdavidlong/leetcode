 ...
 */
public class Q0770_BasicCalculatorIV {
    ...
    public static void main(String[] args) {
        Q0770_BasicCalculatorIV sol = new Q0770_BasicCalculatorIV();
        List<String> output = sol.basicCalculatorIV("e + 8 - a + 5", new String[] {"e"}, new int[] {1});
        List<String> output2 = sol.basicCalculatorIV("e - 8 + temperature - pressure", new String[] {"e", "temperature"}, new int[] {1, 12});
        List<String> output3 = sol.basicCalculatorIV("(e + 8) * (e - 8)", new String[] {}, new int[] {});
        List<String> output4 = sol.basicCalculatorIV("7 - 7", new String[] {}, new int[] {});
        List<String> output5 = sol.basicCalculatorIV("a * b * c + b * a * c * 4", new String[] {}, new int[] {});
    }
}
