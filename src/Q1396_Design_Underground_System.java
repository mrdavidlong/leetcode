...
public class Q1396_Design_Underground_System {
    class UndergroundSystem {
        private Map<String, Pair<Double, Double>> journeyData = new HashMap<>(); // startStation + "->" + endStation, Pair<>(totalTripTime, totalTrips)
        private Map<Integer, Pair<String, Integer>> checkInData = new HashMap<>(); // userID, Pair<>(stationName, t)
