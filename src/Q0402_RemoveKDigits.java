...
public class Q0402_RemoveKDigits {
    ...
    public static void main(String[] args) {
        Q0402_RemoveKDigits sol = new Q0402_RemoveKDigits();
        String result1 =  sol.removeKdigits("1432219", 3);
        String result2 = sol.removeKdigits("10200", 1);
        String result3 = sol.removeKdigits("10", 2);
        String result4 = sol.removeKdigits("111111", 2);
    }
}
