 ...
 */
public class Q0751_IPToCIDR {
    /*
    https://leetcode.com/problems/ip-to-cidr/solution/
...
In a more general setting, we use the bit lengths of both n and start & -start (the lowest bit of start) to compute the mask which represents
2
32
−
mask
...
In Java and C++, we should be careful to use long data types to represent the converted ip addresses, since the number could exceed
2
31
2
31
