 ...
 */
public class Q0126_WordLadderII {
    /*
...
2). Use DFS to output paths with the same distance as the shortest distance from distance HashMap: compare if the distance of the next level node equals the distance of the current node + 1.
    ...
    public List<List<String>> findLadders(String start, String end, List<String> wordList) {
        ...
        dict.add(start);
        bfs(start, end, dict, nodeNeighbors, distance); // build nodeNeighbors and distance
...
//  ["hit","hot","lot","log","cog"]
//]
        Q0126_WordLadderII sol = new Q0126_WordLadderII();
        List<List<String>> output = sol.findLadders("hit", "cog", Arrays.asList("hot","dot","dog","lot","log","cog"));
