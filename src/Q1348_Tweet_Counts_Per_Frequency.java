...
public class Q1348_Tweet_Counts_Per_Frequency {
    public static class TweetCounts {
        ...
        public List<Integer> getTweetCountsPerFrequency(String freq, String tweetName, int startTime, int endTime) {
            ...
            // endTime + 1, because subMap toKey (second parameter) is exclusive
    ...
    public static void main(String[] args) {
        TweetCounts tweetCount = new TweetCounts();
        tweetCount.recordTweet("tweet3", 0);
        tweetCount.recordTweet("tweet3", 60);
        tweetCount.recordTweet("tweet3", 10);
        List<Integer> result1 = tweetCount.getTweetCountsPerFrequency("minute", "tweet3", 0, 59);
        List<Integer> result2 = tweetCount.getTweetCountsPerFrequency("minute", "tweet3", 0, 60);
        tweetCount.recordTweet("tweet3", 120);
        List<Integer> result3 = tweetCount.getTweetCountsPerFrequency("hour", "tweet3", 0, 210);
    }
}
